  ...
  <div v-if="show">
    <el-form label-position="top">
      ...
      <template v-if="data.type == 'button'">
        <el-form-item label="按钮图标" v-if="data.type == 'button'">
          <el-select v-model="data.options.icon" clearable>
            <el-option value="el-icon-plus">添加</el-option>
            <el-option value="el-icon-delete">删除</el-option>
            <el-option value="el-icon-edit">编辑</el-option>
            <el-option value="el-icon-search">查询</el-option>
            <el-option value="el-icon-download">下载</el-option>
            <el-option value="el-icon-share">分享</el-option>
            <el-option value="el-icon-edit-outline">在线编辑</el-option>
            <el-option value="el-icon-picture">图片</el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="按钮类型" v-if="data.type == 'button'">
          <el-select v-model="data.options.buttonType" clearable>
            <el-option value="primary">主要按钮</el-option>
            <el-option value="success">成功按钮</el-option>
            <el-option value="warning">警告按钮</el-option>
            <el-option value="danger">危险按钮</el-option>
            <el-option value="info">信息按钮</el-option>
            <el-option value="text">文字按钮</el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="按钮大小" v-if="data.type == 'button'">
          <el-select v-model="data.options.buttonSize" clearable>
            <el-option value="medium">大</el-option>
            <el-option value="small">中等</el-option>
            <el-option value="mini">小</el-option>
          </el-select>
        </el-form-item>
      </template>
      ...
      <el-form-item label="默认值" v-if="Object.keys(data.options).indexOf('defaultValue')>=0 && (data.type=='button' || data.type == 'textarea' || data.type == 'input' || data.type=='rate' || data.type=='color' || data.type=='switch')">
      ...
      <!-- 按钮添加远程属性 -->
      <el-form-item label="是否绑定事件" v-if="Object.keys(data.options).indexOf('methodRjs')>=0">
        <el-switch v-model="data.options.methodBody.remote">
        </el-switch>
      </el-form-item>
      <!-- 按钮添加远程属性 -->
