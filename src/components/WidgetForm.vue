      ...
      if (this.data.list[newIndex].type === 'table') {
        this.$set(this.data.list, newIndex, {
          ...
          options: {
            ...
            pagination: {
              ...this.data.list[newIndex].options.pagination
            }
          }
        })
      }
      if (this.data.list[newIndex].type === 'button') {
        this.$set(this.data.list, newIndex, {
          ...this.data.list[newIndex],
          options: {
            ...this.data.list[newIndex].options,
            methodBody: {
              ...this.data.list[newIndex].options.methodBody
            },
            pagination: {
              ...this.data.list[newIndex].options.pagination
            }
      ...
      if (row.columns[colIndex].list[newIndex].type === 'table') {
        this.$set(row.columns[colIndex].list, newIndex, {
          ...
          options: {
            ...
            pagination: {
              ...row.columns[colIndex].list[newIndex].options.pagination
            }
          }
        })
      }
      if (row.columns[colIndex].list[newIndex].type === 'button') {
        this.$set(row.columns[colIndex].list, newIndex, {
          ...row.columns[colIndex].list[newIndex],
          options: {
            ...row.columns[colIndex].list[newIndex].options,
            methodBody: {
              ...row.columns[colIndex].list[newIndex].options.methodBody
            },
            pagination: {
              ...row.columns[colIndex].list[newIndex].options.pagination
            }
